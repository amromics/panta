...
#pip install .
rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-1.txt 2>&1
rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-12.txt
rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-123.txt
rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-1234.txt
rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-12345.txt
...
rm -r out/Kp1500/g_mmseq_a_diamond_c_mcl_hash_opt2
...
/usr/bin/time -v  panta main -m g_mmseq_a_diamond_c_mcl_hash_opt2   --dont-split -o  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_1/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-1.txt 2>&1

/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash_opt2   --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_2/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-12.txt 2>&1
/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash_opt2 --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_3/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-123.txt 2>&1
/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash_opt2 --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_4/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-1234.txt 2>&1
/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash_opt2 --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_5/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-Kp1500-add-12345.txt 2>&1

/usr/bin/time -v  panta main -m g_mmseq_a_diamond_c_mcl_hash  --dont-split -o  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_1/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash-Kp1500-1.txt 2>&1

/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_2/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash-Kp1500-add-12.txt 2>&1
/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_3/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash-Kp1500-add-123.txt 2>&1
/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_4/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash-Kp1500-add-1234.txt 2>&1
/usr/bin/time -v  panta add -m g_mmseq_a_diamond_c_mcl_hash --dont-split -c  out/Kp1500/g_mmseq_a_diamond_c_mcl_hash -g /mnt/data/data/amromics/panta2/panta/examples/Kp1500/batch_5/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash-Kp1500-add-12345.txt 2>&1
...
#rm  run-g_mmseq_a_diamond_c_mcl_hash_opt2-test-main.txt
#rm run-g_mmseq_a_ems_c_mcl_unique-test-all.txt
#rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-test-add-1.txt
#rm run-g_mmseq_a_diamond_c_mcl_hash_opt2-test-add-2.txt 2>&1
#rm run-g_mmseq_a_diamond_c_mcl_hash_old-test-add-3.txt
#rm -r out/test/g_mmseq_a_diamond_c_mcl_hash_opt2
#rm -r out/test/g_mmseq_a_diamond_c_mcl_unique5_all
#rm -r out/test/g_mmseq_a_diamond_c_mcl_unique5_12
#/usr/bin/time -v  panta main -t 8 -m g_mmseq_a_diamond_c_mcl_hash_opt2  --dont-split  -o out/test/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/test/main/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-test-main.txt 2>&1
...
#/usr/bin/time -v  panta add -t 8 -m g_mmseq_a_diamond_c_mcl_hash_opt2 --dont-split -c  out/test/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/test/add/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-test-add-1.txt 2>&1
#/usr/bin/time -v  panta add -t 8 -m g_mmseq_a_diamond_c_mcl_hash_opt2 --dont-split -c  out/test/g_mmseq_a_diamond_c_mcl_hash_opt2 -g /mnt/data/data/amromics/panta2/panta/examples/test/add2/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-test-add-2.txt 2>&1
#/usr/bin/time -v  panta add -t 8 -m g_mmseq_a_diamond_c_mcl_hash --dont-split -c  out/test/g_mmseq_a_diamond_c_mcl_hash_old -g /mnt/data/data/amromics/panta2/panta/examples/test/add3/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_old-test-add-3.txt 2>&1
...
#/usr/bin/time -v  panta main -t 8 -m g_mmseq_a_diamond_c_mcl_hash_opt2  --dont-split  -o out/sp600/g_mmseq_a_diamond_c_mcl_hash_opt2 -g examples/Sp600/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-sp600-main.txt 2>&1
#/usr/bin/time -v  panta add -t 8 -m g_mmseq_a_diamond_c_mcl_hash_opt2 --dont-split -c  out/sp600/g_mmseq_a_diamond_c_mcl_hash_opt2 -g examples/Sp300/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_opt2-sp600-add.txt 2>&1
#/usr/bin/time -v  panta main -t 8 -m g_mmseq_a_diamond_c_mcl_hash  --dont-split  -o out/sp600/g_mmseq_a_diamond_c_mcl_hash_old -g examples/Sp600/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_old-sp600-main.txt 2>&1
#/usr/bin/time -v  panta add -t 8 -m g_mmseq_a_diamond_c_mcl_hash --dont-split -c  out/sp600/g_mmseq_a_diamond_c_mcl_hash_old -g examples/Sp300/*.gff >> run-g_mmseq_a_diamond_c_mcl_hash_old-sp600-add.txt 2>&1
